        ...
        <div class="form-wrap">
          <div class="form-group">
            ...
            <select class="form-control"
              ...
              <option value="-1">your own liquid</option>
            </select>
          </div>
          <div class="form-group">
        ...
        <div class="form-wrap">
          <div class="form-group">
            ...
            <select class="form-control" onInput={e => this.densityOfSolid = (e.target as HTMLInputElement).value} >
              <option value="0.7">Birchwood (0.7)</option>
              <option value="2.7">Aluminium (2.7)</option>
              <option value="9.7">Copper (9.0)</option>
              <option value="10.5">Silver (10.5)</option>
              <option value="11.3">Lead (11.3)</option>
              <option value="-1">your own solid</option>
            </select>
          </div>
          <div class="form-group">
            <label htmlFor="">Density</label>
            ...
            <g class="cls-27">
              <g id="Layer_0" data-name="Layer 0">
                ...
                <g id="Layer_5" data-name="Layer 5">
                  <circle ref={el => this.ballRef = el as SVGElement} class="cls-33" cx="483.69" cy="476.27" r="40" />
                </g>
